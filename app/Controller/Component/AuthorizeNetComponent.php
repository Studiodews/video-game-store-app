...
class AuthorizeNetComponent extends Component { 
    ...
    */ 
    ...
    protected $login_id = '467w2QbtZ8N';
    protected $transaction_key = '684jAnrPPL323J4v';
   ...
   /* function startup(&$controller) { 
    ...
    function chargeCard($loginid, $trankey, $ccnum, $ccexpmonth, $ccexpyear, $ccver, $live, $amount, $tax, $shipping, $desc, $billinginfo, $email, $phone, $shippinginfo) {
        ...
        $auth_net_login_id            = $this->login_id;//$loginid; 
        $auth_net_tran_key            = $this->transaction_key;//$trankey; 
       ...
       /* curl_setopt($ch, CURLOPT_HTTPPROXYTUNNEL, true);  
        ...
        curl_close ($ch); 
         $responsearray= explode("|", $resp);//store response in an array
